      ...
      <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
        ...
        <div id="hero">
          <div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
            <div class="item" style="background-image: url(assets/images/sliders/banner0.gif);">
            ...
            <div class="item" style="background-image: url(assets/images/sliders/banner2.png);">
              <div class="container-fluid">
                <div class="caption bg-color vertical-center text-left">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">Thanh Toán dễ dàng</h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="hidden-md col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">Miễn Phí Ship Toàn Quóc</h4>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 col-sm-4 col-lg-4">
                <div class="info-box">
                  <div class="row">
                    <div class="col-xs-12">
                      <h4 class="info-box-heading green">Săn Sale dễ dàng</h4>
                    </div>
                  </div>
                </div>
              </div>
